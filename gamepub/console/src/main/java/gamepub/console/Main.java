...
public class Main {
    ...
    public static void main(String[] args) throws Exception{
        ...
        //String url = "http://api.steampowered.com/ISteamApps/GetAppList/v2"; //all games
        String url = "http://api.steampowered.com/ISteamNews/GetNewsForApp/v0002/?appid="; //news by game
        ...
        //  game.setName(jsonArray.getJSONObject(i).getString("name"));se
        ...
        for(int i=0; i<games.size(); i++){
            ...
            Thread.sleep(1000);
            String json = loader.sendGet(url+game.getSteamId()+"\"");
            if (json != null) {
                JSONObject jsonObject = new JSONObject(json);
